                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add-event') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="eventName" type="text" class="form-control{{ $errors->has('eventName') ? ' is-invalid' : '' }}" name="eventName" value="{{ old('eventName') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="eventDateFrom" type="date" class="form-control{{ $errors->has('eventdate') ? ' is-invalid' : '' }}" name="eventDateFrom" required autofocus>
                          ...
                          <div class="form-group row">
                            <label for="eventDateTo" class="col-md-4 col-form-label text-md-right">{{ __('Event Date To (Optional)') }}</label>

                            <div class="col-md-6">
                                <input id="eventDateTo" type="date" class="form-control{{ $errors->has('eventDateTo') ? ' is-invalid' : '' }}" name="eventDateTo"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="eventVenue" type="text" class="form-control{{ $errors->has('eventVenue') ? ' is-invalid' : '' }}" name="eventVenue" value="{{ old('eventVenue') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="eventTime" type="text" class="form-control{{ $errors->has('eventTime') ? ' is-invalid' : '' }}" name="eventTime" value="{{ old('eventTime') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="eventFee" type="text" class="form-control{{ $errors->has('eventFee') ? ' is-invalid' : '' }}" name="eventFee" value="{{ old('eventFee') }}" required>
